...
Namespace WindowsFormsApplication1
    ...
    <ToolboxItem(True), DefaultBindableProperty("Position"), ToolboxBitmap(GetType(ProgressBar), "WindowsFormsApplication1.ProgressBar.bmp"), ToolboxBitmap32Attribute("WindowsFormsApplication1.ProgressBarLarge.png, WindowsFormsApplication1")>
